...
VARIANT_CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "EXP_C2": {
        "description": "C2: layered candidate strategy with shared rerank/postprocess",
        "reindex_mode": "title_context_filename",
        "requires_reindex": False,
        "env": {
            "RAG_INDEX_PROFILE": "v3_quality",
    ...
    "EXP_C25": {
        "description": "C2.5: layered candidate strategy with shared rerank/postprocess",
        "reindex_mode": "title_context_filename",
        "requires_reindex": False,
        "env": {
            "RAG_INDEX_PROFILE": "v3_quality",
    ...
    "EXP_C3": {
        "description": "C3: layered candidate strategy with shared rerank/postprocess",
        "reindex_mode": "title_context_filename",
        "requires_reindex": False,
        "env": {
            "RAG_INDEX_PROFILE": "v3_quality",
    ...
    "EXP_C4": {
        "description": "C4: layered candidate strategy with shared rerank/postprocess",
        "reindex_mode": "title_context_filename",
        "requires_reindex": False,
        "env": {
            "RAG_INDEX_PROFILE": "v3_quality",
    ...
    "EXP_C5": {
        "description": "C5: layered candidate strategy with shared rerank/postprocess",
        "reindex_mode": "title_context_filename",
        "requires_reindex": False,
        "env": {
            "RAG_INDEX_PROFILE": "v3_quality",
    ...
    "EXP_C7": {
        "description": "C7: layered candidate strategy with shared rerank/postprocess",
        "reindex_mode": "title_context_filename",
        "requires_reindex": False,
        "env": {
            "RAG_INDEX_PROFILE": "v3_quality",

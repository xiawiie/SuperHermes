...
Generated at: `2026-04-26T00:52:50`
Rows: `1000`
...
- `GB0` collection `embeddings_collection_gold_tc` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=497.000
- `GS1` collection `embeddings_collection_gold_tc` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=497.000
- `GS2` collection `embeddings_collection_gold_tc` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=497.000
- `GS2H` collection `embeddings_collection_gold_tc` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=497.000
- `GS2HR` collection `embeddings_collection_gold_tc` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=497.000
- `GS3` collection `embeddings_collection_gold_tcf` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=559.000
- `V3Q` collection `embeddings_collection_v3_quality` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=559.000
- `V3F` collection `embeddings_collection_v3_fast` coverage: 60/60 (1.000); page_meta=1.000, retrieval_text=1.000, p95_len=559.000
